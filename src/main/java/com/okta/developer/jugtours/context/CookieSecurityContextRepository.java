...
public class CookieSecurityContextRepository implements SecurityContextRepository {
    ...
    private AuthenticationSerializer authenticationSerializer = null; // new JsonAuthenticationSerializer();
    ...
    private Cookie getAuthenticationCookie(HttpServletRequest request) {
        ...
        Optional<Cookie> maybeCookie = Arrays.stream(request.getCookies()).filter(
        		cookie -> cookie.getName().equals(authenticationCookieName)).findFirst();
